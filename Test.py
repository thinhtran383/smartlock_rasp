                        ...
                        while True:
                            ...
                            if pressedKey is not None:
                                ...
                                while waitingForInput:
                                    ...
                                    if pressedKey is not None:
                                        if pressedKey == 'B':
                                            root_passcode = keyInput
                                            keyInput = ''
                                            lcd.lcd_clear()
                                            lcd.lcd_display_string('Verifying...', 1, 0)

                                            if addNewPasscode(root_passcode, newPasscode):
                                                lcd.lcd_clear()
                                                lcd.lcd_display_string('Password added!', 1, 0)
                                                time.sleep(2)
                                            else:
                                                lcd.lcd_clear()
                                                lcd.lcd_display_string('Failed to add password', 1, 0)
                                                time.sleep(2)
